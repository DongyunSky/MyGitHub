package fun.chaoxi.toutiao.util;
...
public class SettingUtils {
    ...
    public boolean getIsNoPhotoMode() {
        return setting.getBoolean("switch_noPhotoMode", false) && NetWorkUtils.isMobileConnected(InitApp.AppContext);
    }
    ...
    public boolean getIsVideoAutoPlay() {
        return setting.getBoolean("video_auto_play", false) && NetWorkUtils.isWifiConnected(InitApp.AppContext);
    }
