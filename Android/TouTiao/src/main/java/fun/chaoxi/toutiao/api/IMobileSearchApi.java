package fun.chaoxi.toutiao.api;


import fun.chaoxi.toutiao.bean.search.SearchRecommentBean;
import fun.chaoxi.toutiao.bean.search.SearchResultBean;
import fun.chaoxi.toutiao.bean.search.SearchSuggestionBean;
import fun.chaoxi.toutiao.bean.search.SearchVideoInfoBean;
